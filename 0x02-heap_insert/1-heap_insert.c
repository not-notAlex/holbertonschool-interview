...
/**
 * maxDepth - returns depth of tree
 * @node: tree to search
 *
 * Return: depth
 */
...
/**
 * find_node - finds the node for new value to insert
 * @root: root of tree to search
 * @depth: current depth into tree
 * @max: max depth of the tree
 * Return: node to insert or NULL if tree is perfect
 */
